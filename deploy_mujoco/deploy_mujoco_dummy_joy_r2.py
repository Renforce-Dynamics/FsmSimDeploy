...
from policy.r2.BeyondMimic import BeyondMimic
...
if __name__ == "__main__":
    ...
    mujoco_yaml_path = os.path.join(current_dir, "config", "mujoco_r2.yaml")
    ...
    FSM_controller.cur_policy = BeyondMimic(state_cmd, policy_output)
    ...
    with mujoco.viewer.launch_passive(mj_model, mj_data) as viewer:
        ...
        while viewer.is_running() and Running:
            try:
                ...
                tau = pd_control(policy_output_action, mj_data.qpos[7:], kps, np.zeros_like(kps), mj_data.qvel[6:], kds)
                mj_data.ctrl[:] = tau
